...
CREATE TABLE motorcycle_specs (
    ...
    model_year SMALLINT UNSIGNED NOT NULL CHECK (model_year >= 1900 AND model_year <= YEAR(CURDATE())),
...
CREATE TABLE trade_in_requests (
    ...
    year SMALLINT UNSIGNED NOT NULL CHECK (year >= 1900 AND year <= YEAR(CURDATE())),
